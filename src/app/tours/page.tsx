...
import { getTours } from "@/features/tour/services/get-tours";
import type { TourSort } from "@/features/tour/types/tour.types";
...
export default async function ToursPage({
  ...
  const sort: TourSort = params.sort === "title_asc" ? "title_asc" : "newest";

  const [result, destinations] = await Promise.all([
    getTours({ q: params.q, destinationId: params.destinationId, sort, page }),
    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-bold sm:text-3xl">Tour</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Khám phá các tour du lịch trọn gói cho chuyến đi tiếp theo của bạn.
          </p>
          ...
          >
            <div className="space-y-1.5">
              ...
              <Input id="q" name="q" defaultValue={params.q} placeholder="Khám phá Sapa, Đà Lạt..." />
            </div>
          ...
          {!result || result.items.length === 0 ? (
            <div className="mt-16 flex flex-col items-center gap-2 py-10 text-center">
              ...
              <p className="font-medium">Không tìm thấy tour phù hợp</p>
                    ...
                    <div className="p-4">
                      ...
                      {tour.durationLabel && (
                        <p className="mt-1 flex items-center gap-1 text-xs text-muted-foreground">
                          ...
                          <span className="line-clamp-1">{tour.durationLabel}</span>
                        </p>
                      )}
